    ...
    return [
        {
            ...
            arrowSize: [(radius * 1.75), (radius * 1)], interactions: ['predatism', 'competition'], animal: 'Cobra Coral',
...

        {
            ...
            arrowSize: [(radius * 1.5),(radius * 1.55),(radius * 0.9),(radius * 1.75), (radius * 1)], interactions: ['competition', 'predatism','predatism','predatism','competition'], animal: 'Graxaim',
...

        {
            ...
            arrowSize: [(radius * 1.5)], interactions: ['competition'], animal: 'Ema',
        ...
        {
            id: 4, source: require('../images/pampa/tuco tuco.jpg'), relatedTo: [6,5], arrowAngulation: [-30,-60], arrowStart: 'RightSide',
            arrowSize: [(radius * 1.45),(radius * 0.9)], interactions: ['competition','comensalism'], animal: 'Tuco Tuco',
        ...
        {
            id: 5, source: require('../images/pampa/veado campero.jpg'), relatedTo: [4], arrowAngulation: [120], arrowStart: 'RightSide',
            arrowSize: [(radius * 0.79)], interactions: ['comensalism'], animal: 'Veado Campero',
...

        {
            ...
            arrowSize: [(radius * 1.2)], interactions: ['competition'], animal: 'Zorrilho',
