    ...
    return [
        {
            ...
            arrowSize: [(radius * 1.14), (radius * 1.35),(radius * 1.35)], interactions: ['predatism','predatism','competition'], animal: 'Cobra Cipó',
...

        {
            ...
            arrowSize: [(radius * 1.35),(radius * 1.35),(radius * 1.35)], interactions: ['predatism','comensalism','competition'], animal: 'Coruja Buraqueira',
...

        {
            ...
            arrowSize: [(radius * 0.57), (radius * 0.57),(radius * 0.57)], interactions: ['predatism', 'predatism', 'comensalism'], animal: 'Gambá',
...

        {
            ...
            arrowSize: [(radius * 1.14),(radius * 1.14),(radius * 1.14),(radius * 1.14)], interactions: ['mutualism','mutualism','comensalism','comensalism'], animal: 'Mandacaru',
...

        {
            ...
            arrowSize: [(radius * 1.14),(radius * 1.14),(radius * 1.14)], interactions: ['competition','comensalism','comensalism'], animal: 'Tatu-Peba',
...

        {
            ...
            arrowSize: [(radius * 0.57),(radius * 0.57)], interactions: ['competition','comensalism'], animal: 'Veado Catingueiro',
